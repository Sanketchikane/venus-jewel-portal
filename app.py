...
# Enforce HTTPS (for Render or production)
@app.before_request
...
def login():
    remembered_user = request.cookies.get('username', '')
...
def register():
    if request.method == 'POST':
        ...
        sheet.append_row([timestamp, full_name, username, hashed_password, contact, org])
